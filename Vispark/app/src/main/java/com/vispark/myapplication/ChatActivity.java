...
public class ChatActivity extends AppCompatActivity
{
    ...
    private final List<com.vispark.myapplication.Messages> messagesList = new ArrayList<>();
    private LinearLayoutManager linearLayoutManager;
    private com.vispark.myapplication.MessageAdapter messageAdapter;
...
//        SendFilesButton = (ImageButton) findViewById(R.id.send_files_btn);
        ...
        messageAdapter = new com.vispark.myapplication.MessageAdapter(messagesList);
    ...
    protected void onStart()
    {
        ...
        RootRef.child("Messages").child(messageSenderID).child(messageReceiverID)
                .addChildEventListener(new ChildEventListener() {
                    ...
                    {
                        com.vispark.myapplication.Messages messages = dataSnapshot.getValue(com.vispark.myapplication.Messages.class);
